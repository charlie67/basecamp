package to.charlie.basecamp.domain.model.query;
 ...
 */
public record WorkoutSearchCriteria(Instant from,
                                    Instant to,
                                    Double minLat,
                                    Double maxLat,
                                    Double minLon,
	 ...
	 */
	public static WorkoutSearchCriteria of(final Instant from,
	                                       final Instant to,
	                                       final Double minLat,
	                                       final Double maxLat,
	                                       final Double minLon,
		...
		if (!complete || minLon > maxLon) {
			return new WorkoutSearchCriteria(from, to, null, null, null, null);
		}
		return new WorkoutSearchCriteria(from, to, minLat, maxLat, minLon, maxLon);
	}
}
